...
class DoctorOne extends StatefulWidget {
  const DoctorOne({super.key});

  @override
  State<DoctorOne> createState() => _DoctorOneState();
}

class _DoctorOneState extends State<DoctorOne> {
  bool loading = false;
  @override
